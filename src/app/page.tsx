...
export default function Home() {
  return (
    <div className="p-8 bg-slate-900 text-slate-100 h-screen">
      <h1 className="font-bold text-3xl flex items-center gap-3 before:w-0.5 before:h-8 before:bg-sky-500 before:flex">
        Ignite Tailwindcss
      </h1>
      <h2>Ignite Tailwindcss</h2>
      <p>Ignite Tailwindcss</p>
